...
public class Laptop {
    ...
    public List<Laptop> filter(Set<Laptop> laptop) {
        ...
        System.out.println("Здрасвуйте, Укажите каие параметры для ноутбука вы бы хотели иметь." +
    ...
    public Set<Laptop> newFilter(Set<Laptop> laptop) {
        ...
        System.out.println("Здрасвуйте, Укажите номер или номера критериев фильтрации ноутбуков," +
